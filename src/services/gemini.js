...
// Flash model for quick operations
const flashModel = genAI.getGenerativeModel({ model: "gemini-2.0-flash" });
// Pro model for final synthesis
...
[
  ...
  try {
    ...
    // Fallback - put all ideas in one direction
    return [{
      direction_id: "D1",
 ...
 * Now internally uses idea nodes
 */
